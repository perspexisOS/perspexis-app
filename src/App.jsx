...
function AuthScreen({ onAuth }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#071827", display: "flex", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      {/* Left panel — branding */}
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "60px 40px", borderRight: "1px solid #243746" }}>
        <div style={{ animation: "fadeUp 0.5s ease both", textAlign: "center" }}>
          <img src="data:image/png;base64," alt="Perspexis" style={{ height: 120, width: "auto", objectFit: "contain", filter: "brightness(1.5) contrast(1.1)", marginBottom: 28 }} />
          <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, color: "#FF7A5C", textTransform: "uppercase", letterSpacing: 3, margin: "0 0 48px" }}>Clarity. Alignment. Momentum.</p>
          <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 320 }}>
            {[["◈", "Identity Layer", "Define your mission, vision, and values."], ["◎", "People Layer", "Clarify roles, ownership, and accountability."], ["◇", "Rhythm Layer", "Build the cadences your team runs on."]].map(([icon, title, desc]) => (
              <div key={title} style={{ display: "flex", alignItems: "flex-start", gap: 14, textAlign: "left" }}>
                <span style={{ fontSize: 18, color: "#FF7A5C", marginTop: 2 }}>{icon}</span>
                <div>
                  <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 600, fontSize: 13, color: "#F5F7FA", margin: "0 0 3px" }}>{title}</p>
                  <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: "#94A3B8", margin: 0, lineHeight: 1.5 }}>{desc}</p>
                </div>
              </div>
            ))}
          </div>
        </div>
        <p style={{ position: "absolute", bottom: 28, fontFamily: "'DM Mono', monospace", fontSize: 8, color: "#243746", textTransform: "uppercase", letterSpacing: 2 }}>Built for Leadership. Designed for Clarity.</p>
      </div>
