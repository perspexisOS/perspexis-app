    ...
    <div style={{ minHeight: "100vh", background: "#071827", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div style={{ width: "100%", maxWidth: 440, padding: "0 24px", animation: "fadeUp 0.4s ease both" }}>
        ...
        <div style={{ background: "#102534", border: "1px solid #243746", borderRadius: 10, padding: 32 }}>
          ...
          <div style={{ marginTop: 20, paddingTop: 20, borderTop: "1px solid #243746" }}>
            <p style={{ textAlign: "center", fontFamily: "'DM Mono', monospace", fontSize: 9, color: "#94A3B8", textTransform: "uppercase", letterSpacing: 1.5, marginBottom: 12 }}>Or continue with</p>
            <button onClick={async () => { await supabase.auth.signInWithOAuth({ provider: "google", options: { redirectTo: window.location.origin } }); }} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, width: "100%", padding: "12px", background: "rgba(255,255,255,0.04)", border: "1px solid #243746", borderRadius: 6, color: "#F5F7FA", fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 13, fontWeight: 500, cursor: "pointer" }}>
